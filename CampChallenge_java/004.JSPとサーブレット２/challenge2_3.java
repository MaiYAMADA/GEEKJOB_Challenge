 ...
 * @author yamada
 */
public class challenge2_3 extends HttpServlet {
...
//2. 作成したメソッドを呼び出し、結果を表示してください。
    ...
    void num(int A,int B,boolean C,PrintWriter pw){
        int d=A*B;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet challenge2_3</title>");            
            out.println("</head>");
            out.println("<body>");
